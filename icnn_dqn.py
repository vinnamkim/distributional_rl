...
def icnn_dqn(agent, n_episodes=1000, max_t=1000, test_interval = 100, test_number = 1):
...
for seed in seeds:
    ...
    env.seed(seed=seed)
    agent = picnn_learner(state_size=env.observation_space.shape[0], action_size= env.action_space.shape[0], actions_range = actions_range, seed=seed, hiddens = [128,128], args = args)
